...
function Hero() {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['Easier.^1000', 'Faster.^1000', 'Better.^1000', 'Simpler.^1000', 'Smarter.^1000'],
      typeSpeed: 50,
      backSpeed: 50,
      loop: true,
      loopCount: Infinity,
...
<div>
  ...
  <div className="relative overflow-hidden pt-4 bg-neutral-900">
    <svg className="absolute -bottom-20 start-1/2 w-[1900px] transform -translate-x-1/2" width={2745} height={488} viewBox="0 0 2745 488" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M0.5 264.891C232.505 337.828 853.749 461.71 1482.69 373.747C2111.63 285.783 2585.54 368.615 2743.87 421.027" className="stroke-green-600" stroke="currentColor" />
