...
function PriceHeader() {
  ...
  <div aria-hidden="true" className="flex -z-[1] absolute -top-48 start-0">
    ...
    <div className="bg-gray-200 opacity-90 blur-3xl w-[577px] h-[300px] transform translate-y-32 dark:bg-neutral-800/60" />
  </div>
  {/* End Gradients */}
  <div className="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
    ...
    <div className="max-w-2xl mx-auto text-center mb-10">
      ...
      <p className="mt-2 lg:text-lg text-gray-100 dark:text-neutral-200">Whatever your status, our offers evolve according to your needs.</p>
    </div>
    {/* End Title */}
    ...
    <div className="mt-6 md:mt-12 grid sm:grid-cols-1 lg:grid-cols-3 gap-3 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
      {/* Card */}
      <div className="hover:scale-105 cursor-pointer transition-all flex flex-col bg-black bg-opacity-30
       border border-gray-200 text-center rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-neutral-800">
        <h4 className="font-medium text-lg text-gray-100 dark:text-neutral-200">Free</h4>
        <span className="mt-7 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-100 dark:text-neutral-200">Free</span>
        ...
        <ul className="mt-7 space-y-2.5 text-sm">
          <li className="flex gap-x-2">
            ...
            <span className="text-gray-100 dark:text-neutral-400">
              1 user
            </span>
          </li>
          <li className="flex gap-x-2">
      ...
      {/* Card */}
      <div className="hover:scale-105 cursor-pointer transition-all flex flex-col bg-black bg-opacity-30
       border-2 border-green-900 text-center shadow-xl rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-green-700">
        <p className="mb-3"><span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-xs uppercase font-semibold  text-green-500 dark:bg-green-900 dark:text-black bg-opacity-30
        ">Most popular</span></p>
        <h4 className="font-medium text-lg text-gray-100 dark:text-neutral-200">Startup</h4>
        <span className="mt-5 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-100 dark:text-neutral-200">
          $39
        </span>
        ...
        <a className="bg-opacity-100 rounded-xl mt-5 py-3 px-4 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-600 text-black bg-opacity-30
      ...
      <div className="hover:scale-105 cursor-pointer transition-all flex flex-col bg-black bg-opacity-30
       border border-gray-200 text-center rounded-2xl p-4 md:p-8 dark:bg-neutral-900 dark:border-neutral-800">
        <h4 className="font-medium text-lg text-gray-100 dark:text-neutral-200">Team</h4>
        <span className="mt-5 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-100 dark:text-neutral-200">
          $89
        </span>
  ...
  <div className="absolute top-1/2 start-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[340px] h-[340px] border border-dashed border-green-200 rounded-full dark:border-green-900/60" />
  <div className="absolute top-1/2 start-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[575px] h-[575px] border border-dashed border-green-200 rounded-full opacity-80 dark:border-green-900/60" />
  <div className="absolute top-1/2 start-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[840px] h-[840px] border border-dashed border-green-200 rounded-full opacity-60 dark:border-green-900/60" />
  <div className="absolute top-1/2 start-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[1080px] h-[1080px] border border-dashed border-green-200 rounded-full opacity-40 dark:border-green-900/60" />
</div>
  )
}
